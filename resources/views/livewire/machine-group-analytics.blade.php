<div>
    @if(!$machineGroup)
        <div class="text-gray-500 dark:text-gray-400">No Machine Group Found</div>
    @else
        @php
            ...
            $chartId = 'machine-group-chart-' . $machineGroup->id;
        @endphp
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
                ...
                {{-- Use the original working widget approach --}}
                <div style="height: 280px;" wire:key="chart-container-{{ $machineGroup->id }}">
                    @livewire('machine-group-status-chart', ['record' => $machineGroup], key('chart-' . $machineGroup->id))
                </div>
            </div>

            {{-- Machine Group Utilization Section --}}
            <div class="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Machine Group Utilization</h3>
            ...
            {{-- Machine Group Information Section --}}
            <div class="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Machine Group Information</h3>

                @php
                    $Name = $machineGroup->group_name ?? '';
                    ...
                    <table class="w-full text-sm border border-gray-300 dark:border-gray-700 text-center bg-white dark:bg-gray-900 rounded-lg overflow-hidden">
                        ...
                        <tbody>
                            <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700">
                                <td class="p-2 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100">{{ $Name }}</td>
                                <td class="p-2 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100">{{ $Description }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="block lg:hidden bg-white dark:bg-gray-900 shadow rounded-lg border border-gray-300 dark:border-gray-700 mt-4">
                    ...
                    <div class="p-4 space-y-3">
                        ...
                        <div>
                            ...
                            <span class="text-gray-900 dark:text-gray-100">{{ $Description }}</span>
                        </div>
                    </div>
                </div>
            </div>
