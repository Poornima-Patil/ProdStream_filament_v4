<div>
        ...
        @php
            ...
            $ganttChart = new SimpleWorkOrderGantt();
            $workOrders = $ganttChart->getWorkOrders();

            $startDate = collect($workOrders)->min('start_date');
            $endDate = collect($workOrders)->max('start_date');
            ...
            $weekColumnWidth = (850 / count($weeks));
        @endphp
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($workOrders as $workOrder)
                                    @php
                                        ...
                                        $actualStart = $actualStart ? Carbon::parse($actualStart) : null;
                                        $actualEnd = $workOrder['actual_end_date'] ?? null;
                                        $actualEnd = $actualEnd ? Carbon::parse($actualEnd) : null;
