...
class MachinePolicy
{
    ...
    {
        return $user->hasPermissionTo(permission: 'View Machine');
    }
    ...
    {
        return $user->hasPermissionTo(permission: 'Create Machine');
    }
    ...
    {
        return $user->hasPermissionTo(permission: 'Edit Machine');
    }
