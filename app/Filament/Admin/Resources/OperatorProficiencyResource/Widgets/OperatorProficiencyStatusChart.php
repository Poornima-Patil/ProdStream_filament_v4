...
namespace App\Filament\Admin\Resources\OperatorProficiencyResource\Widgets;
...
class OperatorProficiencyStatusChart extends ChartWidget
{
    ...
    protected function getData(): array
    {
        ...
        $query = DB::table('work_orders')
            ...
            ->where('operators.operator_proficiency_id', $this->record->id)
